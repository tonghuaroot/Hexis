"""Hexis plugin: Video generation via Runway (#99 extraction from core)."""
...
from .tools import create_video_gen_tools
...
class Plugin(HexisPlugin):
    ...
    def register(self, api: HexisPluginApi) -> None:
        ...
        for handler in create_video_gen_tools(api_key_resolver=_resolve):

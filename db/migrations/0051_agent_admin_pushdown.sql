-- 0051: Agent-admin pushdown (plans/db_pushdown.md Tranche 2 quick wins).
-- apply_agent_config / get_agent_status / spend_energy / mark_user_contact
-- / mood_label / upsert_contact(+from_attendees, +by_name) /
-- record_tool_execution. Baseline mirror: db/65.

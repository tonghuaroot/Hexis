-- 0119: RecMem desk semantics — pinning, list/open/pin/clear, chunk-grain
-- desk loading, and a pin-aware GC that also sweeps desk items whose source
-- document was redacted. Clearing archives; sources always survive.
...
-- recmem_gc: pinned desk items survive idle GC; desk items whose source
-- document was redacted/archived are swept regardless (pins do not shield
-- against redaction).

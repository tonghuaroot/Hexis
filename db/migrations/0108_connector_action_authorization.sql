...
--
-- External provider actions need a DB-owned grant/constraint/audit substrate
-- separate from coarse tool approval. This keeps autonomous sends/replies/
-- label changes portable and inspectable while provider adapters remain thin.

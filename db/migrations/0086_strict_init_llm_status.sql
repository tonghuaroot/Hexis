-- Init status must not treat stale/default config rows as completed model setup.
-- The UI has two explicit roles; both need provider + model before the wizard
-- may advance past the Models step.
